...
<section>
    <h1 class="text-center font-romie text-[26px] md:text-[50px] lg:text-[66px]">
        Cuidados diáros, <br>
...
<section class="container mx-auto text-cor1">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 px-4">
        <?php foreach ($cats as $cat) { ?>
            <div>
                <a class="text-[18px] lg:text-[24px] text-center block font-romie" href="<?php echo $cat["link"] ?>" title="<?php echo $cat["title"] ?>">
                    <?php echo $cat["title"] ?>
                </a>
...
<section class="container mx-auto relative my-[60px] ">
    ...
    <a class="rounded-[8px] drop-shadow-lg translate-x-[-50%] translate-y-[-50%] text-center w-[285px] py-[15px] text-cor1 font-romie text-[30px] absolute top-[50%] left-[50%] bg-white" href="" title="Novidades">
        Novidades
    </a>
</section>
    ...
    <div class="columns-2 lg:columns-3 gap-4">
        ...
        <?php foreach ($sacProd as $index => $prod) { ?>
            <div class="break-inside-avoid-column text-cor1 relative">
                <?php if ($prod["new"]) { ?>
                    <span class="drop-shadow-lg translate-y-[-50%] md:text-[20px] justify-center items-center w-[40px] h-[40px] md:w-[86px] md:h-[86px] flex rounded-full bg-cor3 absolute right-[24px] top-0 font-romie">Novo</span>
                <?php } ?>
                ...
                <div class="flex justify-between items-center pt-4">
                    <span class="font-romie text-[24px]">
                        <?php echo $prod["title"]; ?>
                    </span>
                ...
                <a class="text-[18px] text-cor1 bg-white drop-shadow-lg rounded-[8px] px-4 py-2 mb-4 inline-block my-[25px]" href="" title="Adicionnar">
                    Adicionnar
                </a>
            </div>
            <?php if ($index == 2) { ?>
